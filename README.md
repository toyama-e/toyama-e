...
> 単発で終わりがちな体験を「物語」として蓄積し、自己成長と郷土愛を育む。

- **Stack:** Next.js · FastAPI · Python · TypeScript · Docker · PostgreSQL (Supabase) · Vertex AI (Gemini) · GCS · ffmpeg
- **こだわり:** 小学5年生が直感的に使えるUX設計 × AIによる動画自動生成（ffmpegスクリプト生成）
...
| AI / Cloud | Vertex AI (Gemini) · Google Cloud Storage |
